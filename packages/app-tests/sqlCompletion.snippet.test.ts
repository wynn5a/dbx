...
import { buildSnippetItemsForTest, snippetBodyToTemplate } from "../../apps/desktop/src/lib/sqlCompletion";
import type { SqlSnippet } from "../../apps/desktop/src/types/database";
