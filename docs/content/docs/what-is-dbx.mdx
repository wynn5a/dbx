---
title: What is DBX?
description: DBX is an open-source desktop database workspace for connections, SQL editing, data grids, schema tools, and AI assistance.
---
...
DBX ships as a cross-platform desktop app for macOS, Windows, and Linux. Install it locally and manage all of your databases from native windows on your own machine.
...
- **Local-first**: everything runs in a native desktop app, so your connections and data stay on your machine.
...
<Cards>
  <Card title="Install and Connect" href="/en/docs/getting-started">
    Install the desktop app, then create your first database connection.
  </Card>
