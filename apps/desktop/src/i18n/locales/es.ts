export default {
  ...
  sidebar: {
    ...
    cancelLoading: "Cancelar la carga",
  ...
  connection: {
    ...
    sqliteExtensions: "Extensiones SQLite",
    sqliteExtensionsPlaceholder: "/path/to/regexp.dylib\n/path/to/text.dylib|sqlite3_text_init",
    sqliteExtensionsHint:
      "Un .dylib/.so/.dll por línea. Usa “ruta|punto de entrada” cuando se requiera un punto de entrada. Se cargan al conectar y después se deshabilita load_extension.",
    sqliteExtensionBrowse: "Seleccionar extensión SQLite",
    etcdEndpoints: "Endpoints",
    etcdEndpointsHint: "Un endpoint por línea. Déjalo vacío para usar el host y el puerto de arriba.",
    etcdCaCertPlaceholder: "/path/to/ca.crt",
    etcdCaCertBrowse: "Elegir certificado CA",
    etcdClientAuth: "Autenticación cliente",
    etcdClientCertPlaceholder: "/path/to/client.crt",
    etcdClientKeyPlaceholder: "/path/to/client.key",
    etcdClientCertHint: "El certificado y la clave privada deben indicarse juntos si etcd requiere mTLS.",
    etcdClientCertBrowse: "Elegir certificado cliente",
    etcdClientKeyBrowse: "Elegir clave privada cliente",
    etcdClientCertPairRequired: "El certificado y la clave privada deben indicarse juntos.",
    ...
    errorHintNetwork:
      "No se pudo conectar con el servidor. Comprueba el host y el puerto, y si una VPN o un cortafuegos bloquea la conexión.",
    ...
    sshConnectTimeout: "Tiempo de espera SSH",
    ...
    sshHopEmpty: "Aún no hay capas de túnel o proxy. Añade una capa SSH o proxy para enrutar esta conexión.",
    ...
    idleTimeout: "Tiempo de espera inactivo",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      selectStatement: "Seleccionar sentencia",
  ...
  grid: {
    ...
    columnFormatterHint: "Da formato solo a la visualización; los valores originales no cambian.",
    formatterType: "Tipo",
    ...
    formatterCustomName: "Nombre de la plantilla",
    ...
    formatterCustomTemplateHint:
      "Variables disponibles: ${value}, ${upper}, ${lower}, ${length}. Ponle un nombre para guardarla en la lista.",
    ...
    tableInfo: "Información de la tabla",
    ...
    dataUnavailableHintPrefix: "Pulsa ",
    dataUnavailableHintSuffix: " o haz clic en Actualizar abajo para recargar.",
    queryEditReady: "Editable",
    queryEditReadyHint:
      "Este resultado de una sola tabla proviene de “{table}”. Puedes editar, eliminar o añadir filas y luego usar la acción de cambios pendientes para guardar.",
    rows: "{count} filas",
    ...
    copyResultCsv: "Copiar resultado como CSV",
    copyResultJson: "Copiar resultado como JSON",
    ...
    foreignKeyNavigateHint: "{modifier}+clic para abrir {target} filtrado por este valor",
  ...
  processes: {
    ...
    description:
      "Consultas del lado del servidor iniciadas por DBX en esta conexión. Selecciona una para cancelar o terminar.",
    loading: "Cargando procesos…",
    noProcesses: "No se encontraron procesos en ejecución.",
    colPid: "PID",
    colQuery: "Consulta",
    colState: "Estado",
    colDuration: "Duración",
    thisQuery: "esta consulta",
    sqlServerCancelNote: "SQL Server no permite cancelar solo la consulta; ambas acciones terminan la sesión.",
    terminate: "Terminar conexión",
    cancelQuery: "Cancelar consulta",
    killed: "Proceso {pid} señalizado",
    notRunning: "El proceso {pid} ya no se está ejecutando",
  ...
  explain: {
    ...
    nodesLabel: "Nodos",
    hotspotLabel: "Costo máximo",
    modeLabel: "Modo",
    analyzed: "Analizado",
    emptyHint: "Ejecuta Explicar en una consulta para ver cómo la base de datos la ejecutará.",
  ...
  ai: {
    noConfig: "La IA no está configurada. Configura tu proveedor de IA en Configuración > IA.",
    tableMentionEmpty: "No hay tablas coincidentes",
    ...
    modeHints: {
      ...
      agent: "Ejecuta automáticamente consultas seguras cuando sea posible",
    },
    enableThinking: "Razonamiento",
    enableThinkingHint:
      "Esta opción solo tiene efecto en las API /chat/completions y en los modelos compatibles. Al deshabilitarla puedes reducir considerablemente el uso de tokens, pero la calidad de los resultados generados puede disminuir ligeramente.",
    ...
    apiKeyHint: "Se guarda localmente y solo se envía al proveedor que configures.",
    showApiKey: "Mostrar la clave de API",
    hideApiKey: "Ocultar la clave de API",
    enableThinkingDescription: "Habilita el razonamiento extendido en los modelos que lo admiten.",
  ...
  contextMenu: {
    ...
    createDatabaseCharsetPlaceholder: "p. ej. utf8mb4",
    createDatabaseCollation: "Collation",
    createDatabaseCollationPlaceholder: "p. ej. utf8mb4_unicode_ci",
  ...
  structureEditor: {
    ...
    createTable: "Crear tabla",
    addAnotherColumn: "Agregar otra columna",
    nameYourTable: "Asigna un nombre a la tabla",
    columns: "Columnas",
    indexes: "Índices",
    foreignKeys: "Claves foráneas",
    triggers: "Disparadores",
  ...
  settings: {
    ...
    sqlFormatterLogicalBefore: "Antes",
    sqlFormatterLogicalAfter: "Después",
    ...
    sqlFormatterCasingGroup: "Mayúsculas",
    sqlFormatterIndentationGroup: "Sangría",
    sqlFormatterLayoutGroup: "Diseño",
    sqlFormatterOperatorsGroup: "Operadores",
    sqlFormatterDenseOperatorsDesc: "Eliminar espacios alrededor de operadores binarios.",
    sqlFormatterNewlineBeforeSemicolonDesc: "Colocar el punto y coma final en su propia línea.",
    sqlFormatterPreview: "Vista previa",
    sqlFormatterPreviewLines: "{count} líneas",
    sqlFormatterPreviewWrap: "ajusta a {cols} columnas",
    ...
    mcpTab: "MCP",
    aboutTab: "Acerca de",
    editorSubtitle: "Fuente, tema y ejecución de consultas",
    sqlFormatterSubtitle: "Reglas de formato aplicadas al embellecer SQL",
    appearanceSubtitle: "Idioma, escala, iconos y vista de la cuadrícula de datos",
    navigationSubtitle: "Comportamiento de la barra lateral y gestión de pestañas",
    dataSubtitle: "Valores predeterminados de exportación y manejo de datos",
    shortcutsSubtitle: "Personalizar atajos de teclado",
    aiSubtitle: "Configurar el proveedor y el modelo del asistente de IA",
    aiSectionConnection: "Conexión",
    aiSectionRequest: "Solicitud",
    aiSectionNetwork: "Red",
    ...
    snippetsDeleteTitle: "Eliminar fragmento",
    snippetsSearchPlaceholder: "Buscar fragmentos...",
    snippetsCount: "{count} en total",
    snippetsNoResults: "No se encontraron fragmentos",
    ...
    syncShowPassword: "Mostrar contraseña",
    syncHidePassword: "Ocultar contraseña",
    ...
    executeModeDescription: "Lo que se ejecuta al pulsar el atajo de ejecución.",
    behaviorSection: "Comportamiento",
    wordWrap: "Ajuste de línea",
    wordWrapDescription: "Ajusta las líneas largas de SQL al ancho del editor en lugar de desplazarse horizontalmente.",
    confirmDangerousSqlExecution: "Confirmar antes de SQL peligroso",

    confirmDangerousSqlLead: "Cuando se desactiva,",
    confirmDangerousSqlTrail: "y otras sentencias destructivas se ejecutan sin diálogo de confirmación.",
    ...
    exportBatchSizeDescription:
      "Filas obtenidas por lote al exportar datos de tabla. Un valor más alto es más rápido pero usa más memoria.",
    ...
    shortcutPrevTab: "Pestaña anterior",
    shortcutGotoTabN: "Ir a la pestaña {n}",
    shortcutGotoLastTab: "Ir a la última pestaña",
    ...
    shortcutNoResults: "No se encontraron atajos",
  ...
  driverStore: {
    offlineDownloadHint:
      "Para entornos aislados, descarga los paquetes de drivers sin conexión en una máquina con internet e impórtalos aquí.",
    offlineDownloadLink: "Descargas de drivers sin conexión",
    searchDrivers: "Buscar driver por nombre, tipo, versión...",
    searchJdbcDrivers: "Buscar driver JDBC por nombre o ruta...",
    noMatchingDrivers: "No hay drivers coincidentes.",
  ...
  executionSummary: {
    ...
    success: "Éxito",
    error: "Error",
    returnedTable: "Devuelve una tabla de resultados de {count} columnas",
    noTable: "No se devolvió ninguna tabla de resultados",
  },
  userAdmin: {
    title: "Usuarios y privilegios",
    unsupported:
      "Se admiten conexiones compatibles con MySQL y PostgreSQL. SQL Server, Oracle y otros modelos de permisos se podrán añadir más adelante.",
    ...
    loadingGrants: "Cargando concesiones...",
    emptyUsers: "No se encontraron usuarios, o la cuenta actual no puede leer la lista de usuarios.",
    grants: "Concesiones",
    noGrants: "No se encontraron concesiones",
    privilegeEditor: "Editor de privilegios",
    privilegeHint:
      "Elige privilegios, base de datos y tabla, y previsualiza el SQL antes de aplicar. * significa global o todas las tablas.",
    database: "Base de datos",
    schema: "Schema",
    table: "Tabla",
    scope: "Ámbito de la concesión",
    scopeDatabase: "Base de datos",
    scopeSchema: "Schema",
    scopeTable: "Tabla",
    scopeRole: "Pertenencia a roles",
    memberRole: "Rol del miembro",
    privileges: "Privilegios",
    grantOption: "Permitir conceder a otros (WITH GRANT OPTION)",
    adminOption: "Permitir gestionar miembros (WITH ADMIN OPTION)",
    grant: "Conceder",
    revoke: "Revocar",
    ...
    previewSql: "Previsualizar SQL",
    sqlPreview: "Vista previa del SQL",
    applySql: "Aplicar SQL",
    applySuccess: "Privilegios del usuario actualizados",
    applyFailed: "Error al ejecutar: {message}",
  },
  etcd: {
    prefixPlaceholder: "Prefijo, p. ej. /app/",
    newKey: "Nueva clave",
    loadingKeys: "Cargando claves...",
  ...
  commandPalette: {
    ...
    newQuery: "Nueva consulta",
    newConnection: "Nueva conexión",
    openSqlFile: "Ejecutar archivo SQL",
    dataTransfer: "Transferencia de datos",
    schemaDiff: "Comparar bases de datos",
    dataCompare: "Comparar datos",
    driverStore: "Administrador de drivers",
    sqlLibrary: "Biblioteca SQL",
    queryHistory: "Historial de consultas",
