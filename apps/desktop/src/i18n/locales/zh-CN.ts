export default {
  ...
  connection: {
    ...
    sshHopEmpty: "暂无隧道或代理层。添加 SSH 或代理层以路由此连接。",
  ...
  grid: {
    ...
    copyResultCsv: "复制结果为 CSV",
    copyResultJson: "复制结果为 JSON",
  ...
  processes: {
    title: "运行中的进程",
    description: "DBX 在此连接上启动的服务端查询。选择一项以取消或终止。",
    loading: "正在加载进程…",
    noProcesses: "未发现运行中的进程。",
    colPid: "PID",
    colQuery: "查询",
    colState: "状态",
    colDuration: "时长",
    thisQuery: "当前查询",
    sqlServerCancelNote: "SQL Server 不支持仅取消查询；两种操作都会终止会话。",
    terminate: "终止连接",
    cancelQuery: "取消查询",
    killed: "已向进程 {pid} 发送信号",
    notRunning: "进程 {pid} 已不再运行",
    killFailed: "终止进程失败",
  },
  common: {
    language: "语言",
  ...
  explain: {
    ...
    modeLabel: "模式",
    analyzed: "已分析",
    emptyHint: "对查询执行 Explain，查看数据库将如何执行它。",
  ...
  ai: {
    ...
    apiKeyHint: "仅保存在本地，并且只发送给你配置的提供商。",
  ...
  settings: {
    ...
    sqlFormatterLogicalBefore: "运算符前",
    sqlFormatterLogicalAfter: "运算符后",
    ...
    sqlFormatterCasingGroup: "大小写",
    sqlFormatterIndentationGroup: "缩进",
    sqlFormatterLayoutGroup: "布局",
    sqlFormatterOperatorsGroup: "运算符",
    sqlFormatterDenseOperatorsDesc: "移除二元运算符两侧的空格。",
    sqlFormatterNewlineBeforeSemicolonDesc: "将语句结尾的分号单独放在一行。",
    sqlFormatterPreview: "预览",
    sqlFormatterPreviewLines: "{count} 行",
    sqlFormatterPreviewWrap: "在 {cols} 列处换行",
    appearanceTab: "外观",
    navigationTab: "导航",
    dataTab: "数据",
    redisTab: "Redis",
    ...
    mcpTab: "MCP",
    aboutTab: "关于我们",
    editorSubtitle: "字体、主题与查询执行",
    sqlFormatterSubtitle: "美化 SQL 时应用的格式化规则",
    appearanceSubtitle: "语言、缩放、图标与数据网格显示",
    navigationSubtitle: "侧边栏行为与标签页处理",
    dataSubtitle: "导出与数据处理默认设置",
    shortcutsSubtitle: "自定义键盘快捷键",
    aiSubtitle: "配置 AI 助手的提供商与模型",
    aiSectionConnection: "连接",
    aiSectionRequest: "请求",
    aiSectionNetwork: "网络",
    fontFamily: "字体",
    selectFont: "选择字体...",
    ...
    syncShowPassword: "显示密码",
    syncHidePassword: "隐藏密码",
    ...
    executeModeDescription: "按下执行快捷键时运行的内容。",
    behaviorSection: "行为",
    wordWrap: "自动换行",
    ...
    exportBatchSizeDescription: "导出表数据时每批次获取的行数。数值越大速度越快，但占用更多内存。",
    exportSection: "导出",
    ...
    shortcutGotoTabN: "跳转到第 {n} 个标签页",
    shortcutGotoLastTab: "跳转到最后一个标签页",
