export default {
  app: {
    unhandledErrorTitle: "Ocorreu um erro inesperado",
    unhandledErrorExportHint:
      "Os detalhes foram registrados no log de depuração. Você pode exportá-lo em Configurações → Editor ao reportar o problema.",
  },
  toolbar: {
  ...
  sidebar: {
    ...
    cancelLoading: "Cancelar carregamento",
  ...
  savedSql: {
    add: "Adicionar à Biblioteca SQL",
    connection: "Conexão",
    newFile: "Novo arquivo SQL",
    newFileDefault: "Nova Consulta",
    empty: "Nenhum SQL salvo ainda",
    selectConnectionFirst: "Selecione uma conexão primeiro",
  ...
  connection: {
    ...
    etcdEndpointsHint: "Um endpoint por linha. Deixe em branco para usar o host e a porta acima.",
    ...
    etcdClientCertHint:
      "O certificado e a chave privada do cliente devem ser fornecidos juntos quando o etcd exige mTLS.",
    ...
    errorHintNetwork:
      "Não foi possível conectar ao servidor. Verifique o host e a porta, e se uma VPN ou firewall está bloqueando a conexão.",
    ...
    sshHopEmpty: "Nenhuma camada de túnel ou proxy ainda. Adicione uma camada SSH ou proxy para rotear esta conexão.",
  ...
  editor: {
    ...
    contextMenu: {
      ...
      selectStatement: "Selecionar instrução",
  ...
  processes: {
    ...
    description:
      "Consultas do lado do servidor iniciadas pelo DBX nesta conexão. Selecione uma para cancelar ou encerrar.",
    loading: "Carregando processos…",
    noProcesses: "Nenhum processo em execução encontrado.",
    colPid: "PID",
    colQuery: "Consulta",
    colState: "Estado",
    colDuration: "Duração",
    thisQuery: "esta consulta",
    sqlServerCancelNote: "O SQL Server não permite cancelar apenas a consulta; ambas as ações encerram a sessão.",
    terminate: "Encerrar conexão",
    cancelQuery: "Cancelar consulta",
    killed: "Processo {pid} sinalizado",
    notRunning: "O processo {pid} não está mais em execução",
  ...
  explain: {
    ...
    nodesLabel: "Nós",
    hotspotLabel: "Custo máximo",
    modeLabel: "Modo",
    analyzed: "Analisado",
    emptyHint: "Execute Explicar em uma consulta para ver como o banco de dados a executará.",
  ...
  ai: {
    ...
    toolConfirm: {
      ...
      production: "Produção",
      highRiskAck: "Revisei esta instrução e confirmo que quero executá-la.",
      reasons: {
    ...
    proxyDescription: "Roteia o tráfego do assistente por um proxy local ou corporativo.",
    apiKeyHint: "Armazenada localmente e enviada apenas ao provedor que você configurar.",
    showApiKey: "Mostrar chave de API",
    hideApiKey: "Ocultar chave de API",
    enableThinkingDescription: "Ativa o raciocínio estendido para modelos que oferecem suporte.",
  ...
  structureEditor: {
    ...
    nameYourTable: "Nomeie sua tabela",
    columns: "Colunas",
    indexes: "Índices",
    foreignKeys: "Chaves estrangeiras",
    triggers: "Triggers",
  ...
  settings: {
    ...
    sqlFormatterLogicalAfter: "Depois",
    ...
    sqlFormatterCasingGroup: "Maiúsculas",
    sqlFormatterIndentationGroup: "Indentação",
    sqlFormatterLayoutGroup: "Layout",
    sqlFormatterOperatorsGroup: "Operadores",
    sqlFormatterDenseOperatorsDesc: "Remover espaços ao redor de operadores binários.",
    sqlFormatterNewlineBeforeSemicolonDesc: "Colocar o ponto e vírgula final em sua própria linha.",
    sqlFormatterPreview: "Pré-visualização",
    sqlFormatterPreviewLines: "{count} linhas",
    sqlFormatterPreviewWrap: "quebra em {cols} colunas",
    ...
    mcpTab: "MCP",
    aboutTab: "Sobre",
    editorSubtitle: "Fonte, tema e execução de consultas",
    sqlFormatterSubtitle: "Regras de formatação aplicadas ao embelezar SQL",
    appearanceSubtitle: "Idioma, escala, ícones e exibição da grade de dados",
    navigationSubtitle: "Comportamento da barra lateral e gerenciamento de abas",
    dataSubtitle: "Padrões de exportação e tratamento de dados",
    shortcutsSubtitle: "Personalizar atalhos de teclado",
    aiSubtitle: "Configurar o provedor e o modelo do assistente de IA",
    aiSectionConnection: "Conexão",
    aiSectionRequest: "Requisição",
    aiSectionNetwork: "Rede",
    ...
    snippetsDeleteTitle: "Excluir snippet",
    snippetsSearchPlaceholder: "Buscar snippets...",
    snippetsCount: "{count} no total",
    snippetsNoResults: "Nenhum snippet encontrado",
    ...
    syncShowPassword: "Mostrar senha",
    syncHidePassword: "Ocultar senha",
    ...
    executeModeDescription: "O que é executado ao pressionar o atalho de execução.",
    behaviorSection: "Comportamento",
    wordWrap: "Quebra de linha",
    wordWrapDescription: "Quebra linhas SQL longas dentro da largura do editor em vez de rolar horizontalmente.",
    confirmDangerousSqlExecution: "Confirmar antes de SQL perigoso",

    confirmDangerousSqlLead: "Quando desativado,",
    confirmDangerousSqlTrail: "e outras instruções destrutivas são executadas sem caixa de diálogo de confirmação.",
    ...
    exportBatchSizeDescription:
      "Linhas buscadas por lote ao exportar dados da tabela. Um valor maior é mais rápido, mas usa mais memória.",
    ...
    shortcutPrevTab: "Aba anterior",
    shortcutGotoTabN: "Ir para a aba {n}",
    shortcutGotoLastTab: "Ir para a última aba",
    ...
    shortcutSearchPlaceholder: "Buscar atalhos...",
    shortcutNoResults: "Nenhum atalho encontrado",
  ...
  driverStore: {
    offlineDownloadHint:
      "Para ambientes sem internet, baixe os pacotes de drivers offline em uma máquina conectada e importe-os aqui.",
    offlineDownloadLink: "Downloads de drivers offline",
    searchDrivers: "Pesquisar driver por nome, tipo, versão...",
    searchJdbcDrivers: "Pesquisar driver JDBC por nome ou caminho...",
  ...
  executionSummary: {
    ...
    success: "Sucesso",
    error: "Erro",
    returnedTable: "Retornou uma tabela de resultados com {count} colunas",
    noTable: "Nenhuma tabela de resultados retornada",
  },
  userAdmin: {
    title: "Usuários e Privilégios",
    unsupported:
      "São suportadas conexões compatíveis com MySQL e PostgreSQL. SQL Server, Oracle e outros modelos de permissões poderão ser adicionados em seguida.",
    ...
    loadingGrants: "Carregando concessões...",
    emptyUsers: "Nenhum usuário encontrado, ou a conta atual não pode ler a lista de usuários.",
    grants: "Concessões",
    noGrants: "Nenhuma concessão encontrada",
    privilegeEditor: "Editor de Privilégios",
    privilegeHint:
      "Escolha privilégios, banco de dados e tabela e visualize o SQL antes de aplicar. * significa global ou todas as tabelas.",
    database: "Banco de dados",
    schema: "Schema",
    table: "Tabela",
    ...
    scopeSchema: "Schema",
    scopeTable: "Tabela",
    scopeRole: "Participação no papel",
    memberRole: "Papel do membro",
    privileges: "Privilégios",
    grantOption: "Permitir conceder a outros (WITH GRANT OPTION)",
    adminOption: "Permitir gerenciar membros (WITH ADMIN OPTION)",
    grant: "Conceder",
    revoke: "Revogar",
  ...
  etcd: {
    prefixPlaceholder: "Prefixo, por exemplo, /app/",
    newKey: "Nova chave",
    loadingKeys: "Carregando chaves...",
    ...
    delete: "Excluir",
    deleteTitle: "Excluir chave do etcd",
  ...
  commandPalette: {
    ...
    categoryWorkspace: "Espaço de trabalho",
    categoryTools: "Ferramentas",
    categoryData: "Dados",
    categoryView: "Visualização",
    newQuery: "Nova Consulta",
    newConnection: "Nova Conexão",
    openSqlFile: "Executar Arquivo SQL",
    dataTransfer: "Transferência de Dados",
    schemaDiff: "Comparar Bancos de Dados",
    dataCompare: "Comparar Dados",
    driverStore: "Gerenciador de Drivers",
    sqlLibrary: "Biblioteca SQL",
    queryHistory: "Histórico de Consultas",
