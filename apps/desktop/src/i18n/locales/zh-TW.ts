export default {
  ...
  savedSql: {
    ...
    newFileDefault: "新增查詢",
    empty: "尚無已儲存的 SQL",
    selectConnectionFirst: "請先選擇一個連線",
  ...
  connection: {
    etcdEndpoints: "端點",
    etcdEndpointsHint: "每行一個端點。留空則使用上方的主機與連接埠。",
    ...
    sshHopEmpty: "尚無通道或代理層。新增 SSH 或代理層以路由此連線。",
  ...
  grid: {
    ...
    dataUnavailableHintSuffix: " 或點擊下方重新整理按鈕重新載入。",
    rows: "{count} 列",
    totalRows: "共 {count} 筆",
  ...
  processes: {
    title: "執行中的程序",
    description: "DBX 在此連線上啟動的伺服器端查詢。選擇一項以取消或終止。",
    loading: "正在載入程序…",
    noProcesses: "未發現執行中的程序。",
    colPid: "PID",
    colQuery: "查詢",
    colState: "狀態",
    colDuration: "時長",
    thisQuery: "目前查詢",
    sqlServerCancelNote: "SQL Server 不支援僅取消查詢；兩種操作都會終止工作階段。",
    terminate: "終止連線",
    cancelQuery: "取消查詢",
    killed: "已向程序 {pid} 傳送訊號",
    notRunning: "程序 {pid} 已不再執行",
    killFailed: "終止程序失敗",
  },
  common: {
    language: "語言",
  ...
  explain: {
    ...
    modeLabel: "模式",
    analyzed: "已分析",
    emptyHint: "對查詢執行 Explain，查看資料庫將如何執行它。",
  ...
  ai: {
    ...
    proxyDescription: "透過本機或企業代理伺服器轉送助手流量。",
    apiKeyHint: "僅儲存在本機，且只會傳送給你設定的供應商。",
    showApiKey: "顯示 API 金鑰",
    hideApiKey: "隱藏 API 金鑰",
    enableThinkingDescription: "為支援的模型啟用延伸推理。",
    proxyUrl: "代理伺服器地址",
  ...
  structureEditor: {
    ...
    newTable: "新增資料表",
    createTable: "建立資料表",
    addAnotherColumn: "新增另一欄",
    nameYourTable: "請填寫資料表名稱",
    columns: "欄位",
    indexes: "索引",
    foreignKeys: "外鍵",
    triggers: "觸發器",
  ...
  redis: {
    copyInsertStatement: "複製 INSERT 語句",
    copyInsertStatementBinary: "二進位資料無法產生 INSERT 語句",
  ...
  settings: {
    ...
    exportBatchSizeDescription: "匯出資料表資料時每批次取得的列數。數值越大速度越快，但會佔用更多記憶體。",
    exportSection: "匯出",
    mcpTitle: "MCP Server",
    mcpDescription: "檢查 Claude Code、Cursor 等開發工具使用的 DBX MCP Server 安裝與版本狀態。",
    mcpChecking: "檢查中",
    ...
    mcpCodexConfigPath: "Codex 可放在 ~/.codex/config.toml 或專案層級的 .codex/config.toml。",
    mcpReadonlyMode: "唯讀模式",
    mcpReadonlyModeDescription: "開啟後會在範例設定附加 DBX_MCP_ALLOW_WRITES=0，MCP 工作階段僅允許查詢。",
    mcpAllowDangerous: "允許危險 SQL",
    mcpAllowDangerousDescription:
      "開啟後會在範例設定附加 DBX_MCP_ALLOW_DANGEROUS_SQL=1，允許 DROP、TRUNCATE、ALTER 等語句。",
    mcpDetectionTiming: "開啟此頁面時會自動偵測，點擊重新檢查可重新整理。",
    mcpNpmBoundary: "DBX 僅偵測並提示 MCP 狀態；安裝與升級仍由 npm 完成。",
    mcpRefresh: "重新檢查",
    mcpGuide: "MCP 指南",
    title: "設定",
    editorTab: "編輯器",
    ...
    sqlFormatterLogicalBefore: "運算子前",
    sqlFormatterLogicalAfter: "運算子後",
    ...
    sqlFormatterCasingGroup: "大小寫",
    sqlFormatterIndentationGroup: "縮排",
    sqlFormatterLayoutGroup: "版面",
    sqlFormatterOperatorsGroup: "運算子",
    sqlFormatterDenseOperatorsDesc: "移除二元運算子兩側的空格。",
    sqlFormatterNewlineBeforeSemicolonDesc: "將語句結尾的分號獨立放在一行。",
    sqlFormatterPreview: "預覽",
    sqlFormatterPreviewLines: "{count} 行",
    sqlFormatterPreviewWrap: "在 {cols} 欄處換行",
    appearanceTab: "外觀",
    navigationTab: "導覽",
    redisTab: "Redis",
    shortcutsTab: "快速鍵",
    ...
    aiTab: "AI",
    aboutTab: "關於我們",
    editorSubtitle: "字型、主題與查詢執行",
    sqlFormatterSubtitle: "美化 SQL 時套用的格式化規則",
    appearanceSubtitle: "語言、縮放、圖示與資料表格顯示",
    navigationSubtitle: "側邊欄行為與分頁處理",
    dataSubtitle: "匯出與資料處理預設值",
    shortcutsSubtitle: "自訂鍵盤快速鍵",
    aiSubtitle: "設定 AI 助手的供應商與模型",
    aiSectionConnection: "連線",
    aiSectionRequest: "請求",
    aiSectionNetwork: "網路",
    fontFamily: "字型",
    selectFont: "選擇字型……",
    ...
    snippetsBodyHint: "用大括號包住單字即可設為佔位符，例如 {table}。插入程式碼片段時，游標會自動選取第一個佔位符。",

    snippetsAddTitle: "新增片段",
    snippetsEditTitle: "編輯片段",
    snippetsDeleteTitle: "刪除片段",
    snippetsSearchPlaceholder: "搜尋片段…",
    snippetsCount: "共 {count} 個",
    snippetsNoResults: "找不到片段",
    ...
    syncShowPassword: "顯示密碼",
    syncHidePassword: "隱藏密碼",
    ...
    executeModeDescription: "按下執行快速鍵時執行的內容。",
    behaviorSection: "行為",
    wordWrap: "自動換行",
    wordWrapDescription: "在編輯器寬度內自動折行顯示長 SQL，而非橫向捲動。",
    confirmDangerousSqlExecution: "執行危險 SQL 前彈出確認",

    confirmDangerousSqlLead: "關閉後，",
    confirmDangerousSqlTrail: "等破壞性語句會直接執行，不再彈出確認對話框。",
    ...
    shortcutNextTab: "下一個標籤頁",
    shortcutPrevTab: "上一個標籤頁",
    shortcutGotoTabN: "跳到第 {n} 個標籤頁",
    shortcutGotoLastTab: "跳到最後一個標籤頁",
  ...
  exportProgress: {
    ...
    error: "匯出失敗",
    cancelled: "匯出已取消。",
    rowsCount: "已匯出 {exported} / {total} 列",
    rowsExported: "已匯出 {count} 列",
    rowsShort: "列",
    cancel: "取消",
    close: "關閉",
    ...
    popoverTitle: "匯出任務",
    clearFinished: "清除已完成",
    showMore: "展開其餘 {count} 個",
    showLess: "收合",
    delete: "移除",
  },
  userAdmin: {
    title: "使用者與權限",
    unsupported: "目前支援 MySQL 相容與 PostgreSQL 相容連線。SQL Server、Oracle 等將依各自的權限模型持續擴充。",
    newUser: "新增使用者",
    anonymous: "匿名使用者",
    roleName: "角色名稱",
    allowLogin: "允許登入",
    searchUser: "搜尋使用者或 Host",
    loadingUsers: "正在載入使用者……",
    loadingGrants: "正在載入授權……",
    emptyUsers: "找不到使用者，或目前帳號沒有讀取使用者清單的權限。",
    grants: "授權",
    noGrants: "尚無授權資訊",
    privilegeEditor: "權限編輯器",
    privilegeHint: "選擇權限、資料庫和資料表，預覽 SQL 後再執行。* 表示全域或全部資料表。",
    database: "資料庫",
    schema: "Schema",
    table: "資料表",
    scope: "授權範圍",
    ...
    memberRole: "成員角色",
    privileges: "權限",
    grantOption: "允許繼續授權 (WITH GRANT OPTION)",
    adminOption: "允許管理成員關係 (WITH ADMIN OPTION)",
    grant: "授權",
    revoke: "撤銷授權",
    username: "使用者名稱",
    host: "Host",
  ...
  etcd: {
    ...
    saved: "key 已儲存",
    deleted: "key 已刪除",
    base64Readonly: "Base64 值在目前版本為唯讀。",
  },
  commandPalette: {
    searchPlaceholder: "搜尋命令…",
    noResults: "找不到命令",
    categoryWorkspace: "工作區",
    categoryTools: "工具",
    categoryData: "資料",
    categoryView: "檢視",
    newQuery: "建立查詢",
    newConnection: "建立連線",
    openSqlFile: "執行 SQL 檔案",
    dataTransfer: "資料傳輸",
    schemaDiff: "比較資料庫",
    dataCompare: "比較資料",
    driverStore: "驅動程式管理器",
