export default {
  ...
  connection: {
    ...
    tunnelLost: "Il tunnel SSH verso {name} è andato perso",
    tunnelLostHint:
      "Più tentativi di riconnessione a {host}:{port} non sono riusciti e sono stati interrotti. Riconnetti la connessione per riprovare.",
    ...
    sshHopEmpty: "Nessun livello di tunnel o proxy. Aggiungi un livello SSH o proxy per instradare questa connessione.",
    ...
    connectTimeout: "Timeout Connessione",
  ...
  editor: {
    ...
    diagnostics: {
      unknownColumn: 'La colonna "{column}" non esiste in "{table}"',
    },
  },
  tabs: {
    etcd: "etcd",
  ...
  grid: {
    ...
    copyResultCsv: "Copia risultato come CSV",
    copyResultJson: "Copia risultato come JSON",
  ...
  explain: {
    ...
    nodesLabel: "Nodi",
    hotspotLabel: "Costo massimo",
    modeLabel: "Modalità",
    analyzed: "Analizzato",
    emptyHint: "Esegui Spiega su una query per vedere come il database la eseguirà.",
  ...
  ai: {
    ...
    apiKeyHint: "Salvata localmente e inviata solo al provider che configuri.",
  ...
  structureEditor: {
    ...
    createTable: "Crea tabella",
    addAnotherColumn: "Aggiungi un'altra colonna",
    nameYourTable: "Assegna un nome alla tabella",
    columns: "Colonne",
    indexes: "Indici",
    foreignKeys: "Chiavi Esterne",
    triggers: "Trigger",
  ...
  settings: {
    ...
    sqlFormatterLogicalBefore: "Prima",
    sqlFormatterLogicalAfter: "Dopo",
    ...
    sqlFormatterCasingGroup: "Maiuscole",
    sqlFormatterIndentationGroup: "Indentazione",
    sqlFormatterLayoutGroup: "Layout",
    sqlFormatterOperatorsGroup: "Operatori",
    sqlFormatterDenseOperatorsDesc: "Rimuove gli spazi attorno agli operatori binari.",
    sqlFormatterNewlineBeforeSemicolonDesc: "Posiziona il punto e virgola finale su una riga a sé.",
    sqlFormatterPreview: "Anteprima",
    sqlFormatterPreviewLines: "{count} righe",
    sqlFormatterPreviewWrap: "a capo a {cols} colonne",
    ...
    editorSubtitle: "Carattere, tema ed esecuzione delle query",
    sqlFormatterSubtitle: "Regole di formattazione applicate quando formatti l'SQL",
    appearanceSubtitle: "Lingua, scala, icone e visualizzazione della griglia dati",
    navigationSubtitle: "Comportamento della barra laterale e gestione delle schede",
    dataSubtitle: "Impostazioni predefinite di esportazione e gestione dati",
    shortcutsSubtitle: "Personalizza le scorciatoie da tastiera",
    aiSubtitle: "Configura il provider e il modello dell'assistente IA",
    aiSectionConnection: "Connessione",
    aiSectionRequest: "Richiesta",
    aiSectionNetwork: "Rete",
    ...
    syncShowPassword: "Mostra password",
    syncHidePassword: "Nascondi password",
    ...
    save: "Salva",
    cancel: "Annulla",
    executeMode: "Modalità Esecuzione",
    executeModeAll: "Esegui tutto l'SQL",
    executeModeCurrent: "Esegui istruzione al cursore",
    executeModeDescription: "Cosa viene eseguito quando premi la scorciatoia di esecuzione.",
    ...
    exportBatchSizeDescription:
      "Righe recuperate per lotto durante l'esportazione dei dati della tabella. Un valore più alto è più veloce ma usa più memoria.",
    ...
    shortcutNextTab: "Scheda successiva",
    shortcutPrevTab: "Scheda precedente",
    shortcutGotoTabN: "Vai alla scheda {n}",
    shortcutGotoLastTab: "Vai all'ultima scheda",
    shortcutCommandPalette: "Palette dei comandi",
    ...
    shortcutNoResults: "Nessuna scorciatoia trovata",
  ...
  commandPalette: {
    ...
    categoryWorkspace: "Area di lavoro",
    categoryTools: "Strumenti",
    categoryData: "Dati",
    categoryView: "Vista",
    newQuery: "Nuova Query",
    newConnection: "Nuova Connessione",
    openSqlFile: "Esegui File SQL",
    dataTransfer: "Trasferimento Dati",
    schemaDiff: "Confronta Database",
    dataCompare: "Confronta Dati",
    driverStore: "Gestione Driver",
    sqlLibrary: "Libreria SQL",
    queryHistory: "Cronologia Query",
