export default {
  ...
  connection: {
    ...
    sshHopEmpty: "No tunnel or proxy layers yet. Add an SSH or proxy layer to route this connection.",
  ...
  processes: {
    ...
    description: "Server-side queries started by DBX on this connection. Select one to cancel or terminate.",
    ...
    thisQuery: "this query",
    sqlServerCancelNote: "SQL Server has no query-only cancel; both actions terminate the session.",
    terminate: "Terminate connection",
    cancelQuery: "Cancel query",
    killed: "Process {pid} signaled",
    notRunning: "Process {pid} is no longer running",
  ...
  explain: {
    ...
    nodesLabel: "Nodes",
    hotspotLabel: "Top cost",
    modeLabel: "Mode",
    analyzed: "Analyzed",
    emptyHint: "Run Explain on a query to see how the database will execute it.",
  ...
  ai: {
    ...
    apiKeyHint: "Stored locally and sent only to the provider you configure.",
  ...
  settings: {
    ...
    sqlFormatterLogicalBefore: "Before",
    sqlFormatterLogicalAfter: "After",
    ...
    sqlFormatterCasingGroup: "Casing",
    sqlFormatterIndentationGroup: "Indentation",
    sqlFormatterLayoutGroup: "Layout",
    sqlFormatterOperatorsGroup: "Operators",
    sqlFormatterDenseOperatorsDesc: "Remove spaces around binary operators.",
    sqlFormatterNewlineBeforeSemicolonDesc: "Place the statement-terminating semicolon on its own line.",
    sqlFormatterPreview: "Preview",
    sqlFormatterPreviewLines: "{count} lines",
    sqlFormatterPreviewWrap: "wraps at {cols} cols",
    ...
    mcpTab: "MCP",
    aboutTab: "About",
    editorSubtitle: "Font, theme, and query execution",
    sqlFormatterSubtitle: "Formatting rules applied when you beautify SQL",
    appearanceSubtitle: "Language, scale, icons, and data grid display",
    navigationSubtitle: "Sidebar behavior and tab handling",
    dataSubtitle: "Export and data handling defaults",
    shortcutsSubtitle: "Customize keyboard shortcuts",
    aiSubtitle: "Configure the AI assistant provider and model",
    aiSectionConnection: "Connection",
    aiSectionRequest: "Request",
    aiSectionNetwork: "Network",
    ...
    syncShowPassword: "Show password",
    syncHidePassword: "Hide password",
    ...
    executeModeDescription: "What runs when you press the execute shortcut.",
    ...
    exportBatchSizeDescription:
      "Rows fetched per batch when exporting table data. A higher value is faster but uses more memory.",
    ...
    shortcutGotoTabN: "Go to tab {n}",
    shortcutGotoLastTab: "Go to last tab",
    ...
    shortcutNoResults: "No shortcuts found",
  ...
  commandPalette: {
    ...
    newQuery: "New Query",
    newConnection: "New Connection",
    openSqlFile: "Execute SQL File",
    dataTransfer: "Data Transfer",
    schemaDiff: "Compare Databases",
    dataCompare: "Compare Data",
    driverStore: "Driver Manager",
    sqlLibrary: "SQL Library",
    queryHistory: "Query History",
