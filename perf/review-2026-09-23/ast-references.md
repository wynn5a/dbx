...
- [ ] **HIGH — column, alias and JOIN completion loses its tables at the positions where it's needed**
...
- [ ] **HIGH — the popup reopens by itself after every keystroke, even where auto-open would not fire**
...
- [ ] **MEDIUM — negative verdicts take part in the stale-prefix fallback**
...
- [ ] **MEDIUM — one backend parse per keystroke, with no measurement**
...
- [ ] **LOW — unknown-column diagnostics now also cover INSERT/UPDATE/DELETE, with no gate tests**
