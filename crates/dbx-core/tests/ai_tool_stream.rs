...
//! the initial-request retry (perf task T31 / plan §5 D6), and the agent loop
//! end to end (perf task T43 / plan §5 D10).
//!
...
//! after the stream started and never for timeouts. The T43 section drives `run_agent_loop` itself across three model turns: two tool
